...
function addFooter() {
    document.write(`
    <!-- ============== ============ -->
    <div id="alert">Alert Box =
        <span id="closebtn">&otimes;</span>
    </div>

    <!-- ============== Footer ============= -->
    <div class="copy-right">
        <p><a href="index.html">SmartPhone Store</a> - All righgts reserved © 2021 - Designed by
            <span style="color: #eee; font-weight: bold">Trung Kiên(ttgt)</span></p>
    </div>`);
}
